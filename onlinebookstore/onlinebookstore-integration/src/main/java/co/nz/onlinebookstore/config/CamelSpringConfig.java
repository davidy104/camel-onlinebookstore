...
import co.nz.onlinebookstore.route.OnlineBookStoreGeneralServiceRoute;
import co.nz.onlinebookstore.route.OnlineBookStoreOrderRoute;
...
public class CamelSpringConfig {
	...
	@Resource
	private CxfEndpoint onlinebookstoreWsEndpoint;

	@Resource
	private OnlineBookStoreGeneralServiceRoute onlineBookStoreGeneralServiceRoute;

	@Resource
	private OnlineBookStoreOrderRoute onlineBookStoreOrderRoute;
	...
	public CamelContext camelContext() throws Exception {
		...
		registry.put("onlinebookstoreWsEndpoint", onlinebookstoreWsEndpoint);
		...
		camelContext.addRoutes(onlineBookStoreGeneralServiceRoute);
		camelContext.addRoutes(onlineBookStoreOrderRoute);
		return camelContext;
	}
